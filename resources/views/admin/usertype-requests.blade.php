...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/admin-usertype-requests.css') }}">
@endsection
                        ...
                        <div>
                            ...
                            <div>
                                <form action="{{ route('admin-usertype-accept') }}" method="post">
                                    ...
                                    @enderror
                                    <input type="number" name="requestId" id="requestId" value="{{$request->user_id}}" required readonly
                                        hidden>
                                ...
                                <form action="{{ route('admin-usertype-reject') }}" method="post">
                                    ...
                                    @error('requestId')
                                        <span class="error">{{ $message }}</span>
                                    @enderror
                                    <input type="number" name="requestId" id="requestId" value="{{$request->user_id}}" readonly required
                                        hidden>
                        ...
                        <div class="user-password-reset">
                            <form action="{{ route('admin-userpassword-reset') }}" method="post">
                                ...
                                @error('password')
                                    <span class="error">{{ $message }}</span>
                                @enderror
                                <input style="display: none" type="number" name="userId" value="{{$request->user_id}}" hidden readonly
                                    required>
